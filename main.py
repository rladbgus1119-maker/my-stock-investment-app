...
TERMS_POOL = [
    ...
    {"t": "서킷브레이커", "d": "급락 시 시장 안정을 위해 매매를 일시 중단함."}
]

QUIZ_POOL = [
    {"q": "상승장을 상징하는 동물은?", "a": "황소(Bull)", "o": ["황소(Bull)", "곰(Bear)", "독수리"]},
    {"q": "기업 이익을 주주에게 현금으로 나눠주는 돈은?", "a": "배당금", "o": ["배당금", "이자", "상여"]},
    {"q": "하락장을 상징하는 동물은?", "a": "곰(Bear)", "o": ["황소", "곰", "사자"]}
]

EXCHANGE_RATE = 1425.0

# --- 3. 세션 상태 초기화 (아카데미 및 모든 변수) ---
